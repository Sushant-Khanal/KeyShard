...
import { Key, Lock, ShieldCheck, Search, Eye, EyeOff, Mail, Phone, Calendar, Tag } from 'lucide-react-native'
...
const Home = () => {
    ...
    return (
        ...
        >
            <View className="flex-1 w-[88%] pt-[60px]">
                    ...
                    {passwordList.length > 0 ? (
                        passwordList.map((item) => {
                            ...
                            return (
                                <View
                                    key={item.id}
                                    className="bg-[#0e1621] border border-[#1f2937] rounded-xl p-4 mb-4"
                                >
                                    {/* TITLE + CATEGORY */}
