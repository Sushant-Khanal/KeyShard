import { Text, View, TextInput, TouchableOpacity, ScrollView, KeyboardAvoidingView, Platform, StyleSheet, Dimensions, StatusBar, Modal } from "react-native"
        ...
        tab ? (
            ...
            >
                ...
                >
                    ...
                    >
                        <ScrollView
                            contentContainerStyle={{ padding: 20, paddingBottom: 100, paddingTop: Platform.OS === 'android' ? StatusBar.currentHeight + 10 : 50 }}
