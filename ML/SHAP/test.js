...
// 2. The Test Loop
const test_pwd = ["admin123", "Secret_2024", "123456", "@&adjh12##"];

console.log("--- VS CODE JS FEATURE TEST ---");
test_pwd.forEach((pwd) => {
  const result = extractFeatures(pwd);
  console.log(`Password: ${pwd.padEnd(15)} | Features: [${result.join(", ")}]`);
});
